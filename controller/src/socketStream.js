...
const keepAlive = async ({sessionId, handleId}) => await sendSocketStream({
  janus: "keepalive",
...
module.exports = {recvNotify, sendStream, keepAlive, createSession, attach, createRoom, joinRoom, configure, addIceCandidate};